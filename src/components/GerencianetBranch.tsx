...
export function GerencianetBranch() {
    return (
        <ul>
            ...
            <li><Link className="noDropdown" to="/financeiro/gerencianet/carnes-parcelas"> Debug de Resposta </Link> </li>
            <li><Link className="noDropdown" to="/financeiro/gerencianet/carnes-parcelas"> Imprimir em Massa </Link> </li>
            <li><Link className="noDropdown" to="/financeiro/gerencianet/carnes-parcelas"> Suportes sem Fatura </Link> </li>
        </ul>
    )
}