...
export function FinancialPulsarSupportWithoutInvoice() {
    return (
        <div id="container">
            <div id="pageContent" >
                <Menu />
                <div id="textContent" >
                    ...
                    <h3>Módulo Financeiro{" > "}Financeiro{" > "}PulsarPay{" > "}Suportes sem Fatura</h3>
                    ...
                    <div>
                        ...
                        <img src="img/86 - fin-pul-pay-sup-sem-fat.png" alt="Financeiro - PulsarPay - Suportes sem Fatura" />
                    </div>
