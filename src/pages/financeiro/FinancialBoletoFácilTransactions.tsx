...
export function FinancialBoletoFácilTransactions() {
    return (
        <div id="container">
            <div id="pageContent" >
                <Menu />
                <div id="textContent" >
                    ...
                    <h3>Módulo Financeiro{" > "}Financeiro{" > "}Boleto Fácil{" > "}Transações</h3>
                    ...
                    <div>
                        ...
                        <img src="img/75 - fin-bol-fac-tran.png" alt="Financeiro - Boleto Fácil - Transações" />
                    </div>
